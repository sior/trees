...
logFile.write(str(updateTime) + " updated times\n")
logFile.write(str(updateTime) + " sunrise set to " + str(sunriseHour) + ":" + str(sunriseMinute) + "\n")
...
timeFile.write(str(sunsetMinute) + "\n")
timeFile.write(updateTime + "\n")
timeFile.close()
